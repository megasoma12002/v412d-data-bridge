...
Status: **REVIEW ONLY** — Soft-Frozen **[0.60, 0.90] KEEP** (was [0.50, 0.95]) · DEFAULT **`E22_v2s_tw` KEEP** · E45 stitch **FORBIDDEN** · retired MDD narrative **`RETIRED_HISTORICAL_NARRATIVE`** (do not invent a replacement)
