...
One accept/defer/reject package for opening **verification + paper** work toward a possible E45 crisis-path stitch.

This pack **does not** stitch E45 live. Charter ACCEPT only unlocks Stage 1–2 research (recompute / paper challenger). Live stitch still needs later checklist + dedicated human PR.
...
## What ACCEPT charter does **not** allow
