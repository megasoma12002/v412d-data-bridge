...
| Held-\|MDD\|≤17% paper target | R1 **`MDD17_HIT_CAGR_OK`** · R2 Stage A **`BAND_ONLY`** · human ACCEPT MDD floor **−14.5%** (rescore still BAND_ONLY; FAST tip-fail / PROXY gb≈1.11) · Soft-Frozen **KEEP** · `HELD_MDD17_R2_CAGR0_PAPER_CHARTER.md` · `ACCEPT_R2_MDD_BAND_FLOOR_14_5_2026-09-25.md` |
