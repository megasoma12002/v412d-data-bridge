...
| Held-\|MDD\|≤17% paper target | R1 **`MDD17_HIT_CAGR_OK`** · R2 Stage B **`TIPSAFE_STRETCH`** (MDD floor **−15%**) · **`COOL_c8_f50_d21` paper observe OPEN/OPERATING** · cutover **BLOCKED** · Soft-Frozen **KEEP** · `COOL_C8_PROXY_OBSERVE_BALLOT_EXECUTED_OPEN.md` |
