...
Tax/receivable formal books (**Item 2 ACCEPT charter — Stage B OPEN**): live DEFAULT Stage-E **TAX0**; residency **本國人 DECIDED** 2026-09-20 · `E22_V3_WITHHOLDING_RESIDENT_NOTE.md` · **`promote_ready=false`** (rate/timing/refunds still OPEN) · charter `FORMAL_TAX_RECEIVABLE_BOOKS_CHARTER.md` · Stage B `E22_V3_TAX_RECV_STAGE_B_STATUS.md`  
