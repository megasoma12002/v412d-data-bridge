...
| Held-\|MDD\|≤17% paper target | Charter OPEN · R1 **`MDD17_HIT_CAGR_OK`** (PROXY winners) · Soft-Frozen **KEEP** · no live wire · `HELD_MDD17_TARGET_PAPER_CHARTER.md` · `HELD_MDD17_TARGET_R1_SCREEN.md` |
