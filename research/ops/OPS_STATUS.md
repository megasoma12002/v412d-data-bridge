...
| Held-\|MDD\|≤17% paper target | R1 **`MDD17_HIT_CAGR_OK`** · R2 CAGR→0 Stage A **`BAND_ONLY`** (near-band FAST gb≈+0.56pp) · Soft-Frozen **KEEP** · no live wire · `HELD_MDD17_TARGET_PAPER_CHARTER.md` · `HELD_MDD17_R2_CAGR0_PAPER_CHARTER.md` |
