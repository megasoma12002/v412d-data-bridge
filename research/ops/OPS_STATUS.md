...
| Held-\|MDD\|≤17% paper target | R1 **`MDD17_HIT_CAGR_OK`** · R2 Stage B tip-safe FAST **`TIPSAFE_STRETCH`** (human ACCEPT MDD floor **−15%**; winners `COOL_c8_f50_d21` gb +0.27pp · `GATE_g04_f50_d21` +0.39pp) · Soft-Frozen **KEEP** · `ACCEPT_R2_MDD_BAND_FLOOR_15_2026-09-25.md` |
