...
Tax/receivable formal books (**Item 2 ACCEPT charter — Stage B OPEN**): live Stage-E **TAX0**; 本國人 + **慣例二擇一 DECIDED** · next ballot **A KEEP TAX0 / B named div28 / C merge-credit** · `E22_V3_WITHHOLDING_RESIDENT_NOTE.md` · **`promote_ready=false`** · Stage B `E22_V3_TAX_RECV_STAGE_B_STATUS.md`  
