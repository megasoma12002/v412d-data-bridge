...
| Field | Value |
|---|---|
| Choice | **OPEN blend-α=0.05 observe** |
| Paper books | `BASE_E16_E18_E22_v2s` vs `BLEND_E45_A05` |
| Overlay | `exposure = 0.95·1 + 0.05·E3_VOLTARGET_WINNER` |
...
P1–P7 integrated analysis held-out preferred **constant blend α≈0.05**:
~**+0.85 pp** MDD improve vs ~**1.07 pp** CAGR giveback (cost-robust through 3×; protection still 2020-concentrated).

Opening this sleeve is **observe-only** (parallel to FULL + A25). Expect YTD/1y PAUSE at current tip. Stitch remains forbidden.
...
| Artifact | Path |
|---|---|
| Ledgers | `scripts/e45_blend005_dual_paper_ledgers.py` |
| Month-end monitor | `scripts/e45_blend005_month_end_monitor.py` |
| Repro | `repro/e45-blend005-dual-paper-observe/` |
| Monitor JSON | `research/gaps/E45_BLEND005_MONTH_END_MONITOR.json` |
...
`E45_BLEND005_OBSERVE_OPEN_2026-09-06__OPERATING__STITCH_FORBIDDEN`
