...
3. Soft / Sleeve / FUSE independent observes reviewed (no silent replace).  
...
Live flags: `LIVE_FUSE_ADDITIVE=True`, `LIVE_DH_EXPOSURE=False` (**DH replaced by COOL_c8** 2026-09-25), `LIVE_COOL_EXPOSURE=True`, `LIVE_E45_STITCH=False`.  
See `LIVE_COOL_C8_CUTOVER_BALLOT_EXECUTED_ACCEPT.md`.
