...
| Soft-assist tiny-MLP Stage A | **PAPER DONE / BEATS_LIVE_NO_OBSERVE_LIFT** (2026-09-12) | numpy tiny MLP + linear Soft buy · DL **0** promote-shaped vs Soft observe · tip MDD dirty on DL books · Soft observe KEEP · no live · `SOFT_DL_MLP_STAGEA_SCREEN.md` |
