...
| Soft-assist deeper-MLP Stage A | **PAPER DONE / BEATS_LIVE_NO_OBSERVE_LIFT** (2026-09-12) | wider h16 + deep 16→8 →1 numpy · DL **0** promote-shaped vs Soft observe · tip MDD dirty on all DL · Soft observe KEEP · no live · `SOFT_DL_DEEPER_STAGEA_SCREEN.md` |
