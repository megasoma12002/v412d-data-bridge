...
| Tip-safe FAST `COOL_c8_f50_d21` observe | **EXECUTED OPEN OBSERVE** (2026-09-25) | Human `開 COOL_c8_f50_d21 paper observe` · dual-paper OPERATING · cutover **BLOCKED** · Soft-Frozen KEEP · `COOL_C8_PROXY_OBSERVE_BALLOT_EXECUTED_OPEN.md` |
