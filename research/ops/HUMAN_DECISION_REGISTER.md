...
| 0d | 民股／四類 × MDD **新機制** (N1→N2→N3) | **DRAFT charter** (2026-09-19) | Paper only · Stage A **not** started until human ACCEPT · ≠ retune SF4/DH/L4 · `PRIV_MDD_NEW_MECHANISM_CHARTER.md` |
