...
| Soft KD/BB sensitivity (soft OR + champ+) | **PAPER DONE / BEATS_CHAMPION** (2026-09-11) | Soft add-score only · **no hard AND** · 16 books · beat-champ **1**=`SOFT_CHAMP_PLUS_K9_LT30_a10` · BB 2nd soft tip-clean≠beat-champ · Soft-assist observe/live **KEEP** · `SOFT_KD_BB_SENSITIVITY_SCREEN.md` · `SOFT_KD_BB_SENSITIVITY_CHARTER.md` |
...
| Soft-assist / sleeve tilt promote | Soft-assist **OPEN OBSERVE EXECUTED** · live KD KEEP · cutover BLOCKED · soft KD/BB sens Stage A **`BEATS_CHAMPION`** (observe swap **not** auto) · sleeve tilt Stage A **`BEATS_LIVE`** · observe ballot OPEN await human · `SLEEVE_LAYER_TILT_OBSERVE_OPEN_BALLOT.md` |
