...
| Offense SOFT near-flat ballot (`SELL_a75`) | **OPEN AWAITING ACCEPT** (2026-09-26) | Floor +0.15 · no live wire until exact `ACCEPT near-flat: SELL_a75 under COOL (CAGR floor +0.15)` · `OFFENSE_SELL_A75_NEAR_FLAT_ACCEPT_BALLOT_OPEN.md` |
