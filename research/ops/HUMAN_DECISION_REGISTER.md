...
| E45 defend-window → handoff paper charter | **PAPER CHARTER OPEN** (2026-09-12) | trigger/exit/handoff SSOT · offense=`LIVE_STACK` · stitch **FORBIDDEN** (no reopen `DROP_E45_A05`) · Stage A not run · `E45_DEFEND_HANDOFF_PAPER_CHARTER.md` |
