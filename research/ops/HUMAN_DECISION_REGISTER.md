...
| Soft×Sleeve paper fuse Stage A charter | **PAPER DONE / FUSE_PROMOTE_SHAPED_BEATS_BOTH** (2026-09-12) | finite 8-book joint-actuator fuse · `FUSE_ADDITIVE` beats both independents on paper · ops auto-fuse still FORBIDDEN · no live / no observe swap · needs separate ballot · `SOFT_SLEEVE_PAPER_FUSE_STAGEA_CHARTER.md` |
