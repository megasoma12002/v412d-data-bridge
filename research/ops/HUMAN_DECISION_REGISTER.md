...
| Soft-assist SELL_a05 observe ballot | **PAPER DONE / OPEN AWAIT HUMAN** (2026-09-12) | Soft-only reconfirm · `SOFT_CHAMP_PLUS_K9_LT30_a10__SELL_a05` promote-shaped held **0.101** > observe **0.085** · draft OPEN Soft-assist observe · no live · `SOFT_SELL_A05_BALLOT_SCREEN.md` · `SOFT_SELL_A05_OBSERVE_BALLOT_OPEN.md` |
| Dual Soft∥Sleeve OPEN ballots posture | **AFFIRMED / NO FUSE** (2026-09-12) | Soft `SELL_a05` + Sleeve `RSI14_a0225` **independent** OPEN ballots · no auto-combo · same-MLP deepen **parked** (DL needs new charter) · live KEEP · `DUAL_OBSERVE_OPEN_BALLOTS_POSTURE.md` |
