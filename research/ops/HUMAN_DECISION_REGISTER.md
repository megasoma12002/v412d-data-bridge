...
| Soft×Sleeve paper fuse Stage A charter | **PAPER CHARTER OPEN / SCREEN NOT RUN** (2026-09-12) | finite 8-book joint-actuator fuse · ops auto-fuse still FORBIDDEN · no live / no observe swap · wait human go to run screen · `SOFT_SLEEVE_PAPER_FUSE_STAGEA_CHARTER.md` |
