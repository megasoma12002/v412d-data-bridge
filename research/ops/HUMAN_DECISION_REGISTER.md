...
| 0k6 | `00631L` **短線輔助** T1–T4 | **STAGE A SHORT_ASSIST_HIT → OBSERVE OPEN** (2026-09-26) | CONFIRM winners `CONF_RET3_A10_H5` / `CONF_RET1_A10_H3` · near-flat OUT · Soft-Frozen KEEP · no live · `COOL_T50_LEV_SHORT_ASSIST_DECISION_PACK.md` · observe `COOL_631L_SHORT_ASSIST_OBSERVE_BALLOT_EXECUTED_OPEN.md` |
...
| 5 | BLEND_025 → live | **NOT DECISION-READY** | Checklist drafted · promote review **2026-09-26 BLOCKED** (`PAUSE_REVIEW` trailing · live SSOT drift) · `BLEND_025_PROMOTE_GATE_REVIEW_2026-09-26.md` · **NOT AUTHORIZED** |
...
| Offense SOFT near-flat ballot (`SELL_a75`) | **EXECUTED ACCEPT → LIVE WIRED** (2026-09-26) | Near-flat floor +0.15 then human `Accept上live` → `ACCEPT Live cutover: SELL_a75 under COOL (keep FUSE+COOL)` · coexists with COOL+FUSE · Soft-Frozen KEEP · `LIVE_SELL_A75_UNDER_COOL_CUTOVER_BALLOT_EXECUTED_ACCEPT.md` |
| `00631L` short-assist `CONF_RET3_A10_H5` observe | **EXECUTED OPEN OBSERVE** (2026-09-26) | Human `OPEN observe: CONF_RET3_A10_H5` · dual-paper OPERATING · cutover BLOCKED · Soft-Frozen KEEP · no live `00631L` · `COOL_631L_SHORT_ASSIST_OBSERVE_BALLOT_EXECUTED_OPEN.md` |
| BLEND_025 promote gate review | **BLOCKED** (2026-09-26) | Month-end PAUSE_REVIEW · checklist NOT AUTHORIZED · Soft-Frozen KEEP · `BLEND_025_PROMOTE_GATE_REVIEW_2026-09-26.md` |
...
| E45 live stitch (A05) | `E45_A05_STITCH_DROPPED.md` · `E45_STITCH_ROLLBACK_ACCEPTED_DROP_A05.md` · dual-paper observe still OPEN | **DROPPED** 2026-09-09 — not pending second ACCEPT; live overlay = **FUSE + COOL_c8** (DH replaced 2026-09-25) + Class D FinPriv V7 F05 |
