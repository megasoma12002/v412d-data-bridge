...
| 6b | Formal tax·receivable books | **ACTIVE ballot** | Charter + decision pack open — ACCEPT/DEFER/REJECT; no DEFAULT flip on this ballot |
...
| Tax / receivable formal books | `FORMAL_TAX_RECEIVABLE_BOOKS_CHARTER.md` · `TAX_RECEIVABLE_CHARTER_DECISION_PACK.md` | **ACTIVE** — awaiting human ballot |
