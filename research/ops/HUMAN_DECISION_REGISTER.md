...
| Telecom within-sleeve alloc (paper) | `TELECOM_WITHIN_SLEEVE_ALLOC_DECISION_PACK.md` · async FIN-parallel **STOP** 2026-09-09 (`TELECOM_WITHIN_SLEEVE_ASYNC_DECISION_PACK.md`); live **TEL_EQUAL KEEP** |
