...
| 0e | 民股 MDD **新機制 V2**（廣度／FinPub–TAIEX 感測器） | **STOP S1** (2026-09-19) | 0 sealed coexist · best `S1_FINZ_15` sealed −0.71 · Soft-Frozen KEEP · `PRIV_MDD_SENSOR_S1_DECISION_PACK.md` |
