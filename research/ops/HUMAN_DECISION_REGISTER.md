...
| Offense SOFT near-flat ballot (`SELL_a75`) | **EXECUTED ACCEPT** (2026-09-26) | Human `ACCEPT near-flat: SELL_a75 under COOL (CAGR floor +0.15)` · paper `NEAR_FLAT_HIT` · observe OPERATING · live Soft amp **BLOCKED** · `OFFENSE_SELL_A75_NEAR_FLAT_ACCEPT_BALLOT_EXECUTED.md` |
