...
| Payment dates | Soft-Frozen restored from `69bb0f4` + Yahoo re-backfill (2026-09-10) — Soft-Frozen cash/stock pay **0** blank; private cash blank pay **0/129 (0%)** (2891/`98年` filled `2010-08-23` from CNYES `#3283475`); stock pay **0** blank · note `E22_PAYMENT_DATE_RESTORE_2026-09-10.md` |
