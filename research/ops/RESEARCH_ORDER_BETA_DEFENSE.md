...
| 2a | Soft/Sleeve densify | **`OFFENSE_CAGR_SOFT`** `#282` · near-flat ballot **OPEN** `SELL_a75` floor +0.15 · `OFFENSE_SELL_A75_NEAR_FLAT_ACCEPT_BALLOT_OPEN.md` |
...
2026-09-26: BLEND_025 promote 檢核 **BLOCKED** · SOFT pocket near-flat ballot **OPEN** (`SELL_a75`) — pack `SOFT_POCKET_NEAR_FLAT_CAGR_FLOOR_PACK.md`.
