...
|---|---:|---|---:|---:|---:|
| `FIN_ONLY_A10` | 0.10 | Financial | +0.91 | +1.25 | +0.29 |
| `FIN_ONLY_A05` | 0.05 | Financial | +0.64 | +0.76 | +0.26 |
| `HIGH_BETA_A05` | 0.05 | 0050,Financial | +0.66 | +0.85 | +0.23 |
| `BLEND_E45_A05` | 0.05 | ALL | +0.70 | +0.96 | +0.22 |
| `HIGH_BETA_A08` | 0.08 | 0050,Financial | +0.80 | +1.17 | +0.21 |
| `HIGH_BETA_A10` | 0.10 | 0050,Financial | +0.87 | +1.34 | +0.20 |
| `FIN_ONLY_A08` | 0.08 | Financial | +0.76 | +1.15 | +0.19 |
| `HIGH_BETA_A15` | 0.15 | 0050,Financial | +0.70 | +1.79 | -0.20 |

**Held-out preferred (paper):** `FIN_ONLY_A10`
