...
起始資本（live + paper early-stack）：**NT$15,000,000**（`scripts/portfolio_capital.py`）。

Soft-Frozen sleeve clips（ACCEPT 2026-09-07）：FIN **[0.50, 0.95]** · TEL **[0.10, 0.35]** · 0050 **[0.10, 0.35]**（`e16_soft_frozen_base.py`）。
