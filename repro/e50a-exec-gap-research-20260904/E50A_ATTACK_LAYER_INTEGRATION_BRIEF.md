...
3. **E45 handoff gate missing / incomplete**  
   ...
   - Claimed MDD **the retired handoff MDD narrative** = `UNVERIFIED_TEXT_ONLY` / **NOT FOUND** in artifacts.  
