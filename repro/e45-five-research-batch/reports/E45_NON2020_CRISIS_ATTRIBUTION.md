...
|---|---:|---:|---:|---:|---|
| `BLEND_E45_A05` | +0.70 | +0.06 | 92% | 1 | [2020] |
| `FIN_ONLY_A10` | +0.91 | +0.17 | 84% | 1 | [2020] |
| `HIGH_BETA_A10` | +0.87 | +0.19 | 82% | 1 | [2020] |
| `CHAL_E45_E3` | +1.71 | +2.17 | 44% | 4 | [2015, 2018, 2020, 2022] |
| `BLEND_E45_A25` | +0.45 | +0.66 | 41% | 2 | [2018, 2020] |
...
| `BLEND_E45_A25` | +0.21 | +0.45 | +0.45 | -1.02 |
| `CHAL_E45_E3` | +0.83 | +0.83 | +1.71 | +0.51 |
| `FIN_ONLY_A10` | -0.06 | +0.17 | +0.91 | -1.67 |
| `HIGH_BETA_A10` | -0.06 | +0.19 | +0.87 | -1.68 |
...
Label: `E45_NON2020_CRISIS_ATTR_2026-09-06__STITCH_FORBIDDEN`
