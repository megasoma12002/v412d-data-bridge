...
**現行 live：** `forward/e21` = **E16 + Exact T+1 E18 + E22_v2s_tw**（畸零股面額 CIL）+ **整股一張=1000** + **起始資本 15M**。  
**Live Soft-Frozen clips（ACCEPT 2026-09-07）：** FIN **[0.50, 0.95]** · TEL **[0.10, 0.35]** · 0050 **[0.10, 0.35]**（單源 `e16_soft_frozen_base.py`）。  
**禁止：** overlay live-wire、改寫歷史 NAV（除 human-authorized replay）、把 held-out PASS 當 cutover 授權、E45 stitch 未經第二次 ACCEPT。
