#!/usr/bin/env python3
"""Canonical claim / status vocabulary (single source for agents & scripts).

Prefer these labels over ad-hoc aliases like NOT_FOUND / UNVERIFIED_TEXT_ONLY.
"""
from __future__ import annotations

# Historical narrative numbers (e.g. E45 −13.16%)
...
# Deprecated aliases — keep for readers, do not emit in new artifacts
