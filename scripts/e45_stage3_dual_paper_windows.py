...
def main() -> int:
    ...
    lines = [
        ...
        "Live stitch: **FORBIDDEN** · Soft-Frozen **" + SOFT_FROZEN_FIN_CLIP_TXT + " KEEP** · DEFAULT books **`E22_v2s_tw` KEEP**",
        f"Retired MDD narrative: **`{e45.CLAIMED_MDD_STATUS}`** (do not invent a replacement)",
        "",
        "## Locked paper books",
        "",
        "| Book | Definition |",
