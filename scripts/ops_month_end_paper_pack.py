...
def main() -> int:
    ...
    payload = {
        ...
        "cutover_note": (
            ...
            "BLEND_025 is observe-only (never cutover from this pack); E45 dual-paper observe is paper-only (stitch still forbidden); E45 blend-α=0.25 observe is paper-only (parallel sleeve)."
        ),
    }
